...
var MyAppModule = (function () {
    ...
    MyAppModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [app_component_1.MyAppComponent, bug_tracker_component_1.BugTracker, trimText_1.TrimText, closedCount_1.ClosedCount, filter_1.Filter, sort_1.Sort, bug_stats_component_1.BugStats, bug_search_component_1.BugSearch, bug_sort_component_1.BugSort],
